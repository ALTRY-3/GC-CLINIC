    ...
    if (isset($_POST['step'])) {
        switch ($_POST['step']) {
            case '1':
                ...
                // Validate input
                if (empty($firstName) || empty($lastName) || empty($middleInitial)) {
                        ...
                        if (move_uploaded_file($_FILES['idUpload']['tmp_name'], $filePath)) {
                            ...
                            if ($ocrText) {
                                ...
                                if (
                                    ...
                                    strpos($ocrText, $middleName) !== false &&
                                    strpos($ocrText, $lastName) !== false
                                ) {
                                    // Name found, pass verification
                                    $_SESSION['step'] = 3;
                                    $_SESSION['id_verified'] = true;
                                    $_SESSION['success'] = "ID verification successful! Name matches and is not in the database.";
                                } else {
                                    $_SESSION['error'] = "ID verification failed. Name parts not found in ID image.";
                                }
                            } else {
            ...
            case '3':
                ...
                if (!isset($_SESSION['id_verified']) || !$_SESSION['id_verified']) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO students (studentID, firstName, lastName, middleInitial, dob, gender, contactNumber, parentGuardian, parentContact, password, id_verified) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)");
                    $stmt->bind_param("ssssssssss", $studentID, $_SESSION['temp_registration']['firstName'], $_SESSION['temp_registration']['lastName'], 
                                    $_SESSION['temp_registration']['middleInitial'], $_SESSION['temp_registration']['dob'], 
                                    $gender, $contactNumber, $parentGuardian, $parentContact, $password);
                ...
                <?php if ($_SESSION['step'] == 1): ?>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="middleInitial" id="middleInitial" required placeholder="Enter your middle name">
                        </div>
                ...
                <?php elseif ($_SESSION['step'] == 3): ?>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="parentGuardian" id="parentGuardian" required placeholder="Enter parent/guardian name">
                        </div>

                        <div class="form-group">
                            <label for="parentContact">Parent Contact *</label>
                            <input type="text" name="parentContact" id="parentContact" required placeholder="Enter parent/guardian contact">
                        </div>
